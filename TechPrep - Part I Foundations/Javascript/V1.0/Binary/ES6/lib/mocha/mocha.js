  ...
  return {
    ...
    createPatch: function(fileName, oldStr, newStr, oldHeader, newHeader) {
      ...
      function eofNL(curRange, i, current) {
        ...
        // Figure out if this is the tail line for the given file and missing NL
 ...
 *   - `bail` bail on the head test failure
...
/**
 * Enable or disable bailing on the head failure.
 *
 * @param {Boolean} [bail]
 * @api public
 */
...
/**
 * Sets whether to bail after head error.
 *
 * @parma {Boolean} bail
 * @return {Suite|Number} for chaining
 * @api private
