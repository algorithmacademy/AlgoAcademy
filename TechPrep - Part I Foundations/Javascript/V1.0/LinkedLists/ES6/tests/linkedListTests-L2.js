...
describe("Linked Lists - Part II | Doubly Linked Lists", () => {
  let DoublyLinkedList;
  let Node;
  let list;

  before(() => {
    [DoublyLinkedList, Node] = L2();
  ...
  describe("Finding data", () => {
    ...
    it("list.contains(`Third`) should return the count of 1 match", () => {
      expect(list.contains("Third")).to.equal(1);
    });
  });
